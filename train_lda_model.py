...
def train_lda_model():
    ...
    print("=" * 60)
    print("Training LDA Model on 20 Newsgroups Dataset")
    print("=" * 60)
    ...
    # Number of topics = number of categories in 20 newsgroups
    num_topics = len(newsgroups_train.target_names)
    ...
    model_path = os.path.join('models_data', 'lda_model_20newsgroups.pkl')
    ...
    print("\n" + "=" * 60)
    print("Sample Topics (Top 10 words per topic):")
    print("=" * 60)
    ...
    for topic_idx, topic in enumerate(lda_model.components_):
        ...
        print(f"\nTopic {topic_idx + 1} ({newsgroups_train.target_names[topic_idx]}):")
