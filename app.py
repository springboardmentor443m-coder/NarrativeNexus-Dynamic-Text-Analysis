    ...
    st.markdown("""
        <div style="display:flex; align-items:center; gap:12px;">
            ...
            <div>
                ...
                <p style="margin:0; font-size:0.9rem; color:#64748B;">Enterprise NLP Pipeline v6.1</p>
            </div>
        </div>
    """, unsafe_allow_html=True)
                        ...
                        <div style="
                            ...
                            <div style="display:flex; justify-content:space-between; align-items:center;">
                                ...
                                <div style="text-align:right;">
                                    ...
                                    <div style="font-size:0.8em; color:#94A3B8;">ID: {t_id if t_id != -1 else 'N/A'} • Conf: {t_conf:.1%}</div>
                                </div>
                            </div>
                        </div>
                        """, unsafe_allow_html=True)
