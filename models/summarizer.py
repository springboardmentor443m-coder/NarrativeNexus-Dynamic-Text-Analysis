...
class TextSummarizer:
    ...
    def summarize(self, text, max_length=150, min_length=50, ratio=0.3):
    ...
    def _extractive_summarize(self, text, ratio=0.3):
        ...
        summary_sentences = [sent for sent, _ in sorted(top_sentences, key=lambda x: sentences.index(x[0]))]
